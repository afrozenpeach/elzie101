...
export type Morph = UsersPermissionsMe | UsersPermissionsMeRole | UsersPermissionsLoginPayload | UserPermissionsPasswordPayload | Blogpost | BlogpostConnection | BlogpostAggregator | BlogpostGroupBy | BlogpostConnectionId | BlogpostConnectionCreated_At | BlogpostConnectionUpdated_At | BlogpostConnectionTitle | BlogpostConnectionContent | BlogpostConnectionPostDate | BlogpostConnectionFeatured | BlogpostConnectionHeaderPhoto | BlogpostConnectionSlug | BlogpostConnectionPublished_At | CreateBlogpostPayload | UpdateBlogpostPayload | DeleteBlogpostPayload | UploadFile | UploadFileConnection | UploadFileAggregator | UploadFileAggregatorSum | UploadFileAggregatorAvg | UploadFileAggregatorMin | UploadFileAggregatorMax | UploadFileGroupBy | UploadFileConnectionId | UploadFileConnectionCreated_At | UploadFileConnectionUpdated_At | UploadFileConnectionName | UploadFileConnectionAlternativeText | UploadFileConnectionCaption | UploadFileConnectionWidth | UploadFileConnectionHeight | UploadFileConnectionFormats | UploadFileConnectionHash | UploadFileConnectionExt | UploadFileConnectionMime | UploadFileConnectionSize | UploadFileConnectionUrl | UploadFileConnectionPreviewUrl | UploadFileConnectionProvider | UploadFileConnectionProvider_Metadata | DeleteFilePayload | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsRoleConnection | UsersPermissionsRoleAggregator | UsersPermissionsRoleGroupBy | UsersPermissionsRoleConnectionId | UsersPermissionsRoleConnectionName | UsersPermissionsRoleConnectionDescription | UsersPermissionsRoleConnectionType | CreateRolePayload | UpdateRolePayload | DeleteRolePayload | UsersPermissionsUser | UsersPermissionsUserConnection | UsersPermissionsUserAggregator | UsersPermissionsUserGroupBy | UsersPermissionsUserConnectionId | UsersPermissionsUserConnectionCreated_At | UsersPermissionsUserConnectionUpdated_At | UsersPermissionsUserConnectionUsername | UsersPermissionsUserConnectionEmail | UsersPermissionsUserConnectionProvider | UsersPermissionsUserConnectionConfirmed | UsersPermissionsUserConnectionBlocked | UsersPermissionsUserConnectionRole | CreateUserPayload | UpdateUserPayload | DeleteUserPayload;
...
export type PostsQuery = (
  ...
  & { blogposts?: Maybe<Array<Maybe<(
    { __typename?: 'Blogpost' }
    & Pick<Blogpost, 'id' | 'title' | 'slug' | 'postDate' | 'featured'>
    & { headerPhoto?: Maybe<(
      { __typename?: 'UploadFile' }
...
export type SinglePostQuery = (
  ...
  & { blogposts?: Maybe<Array<Maybe<(
    { __typename?: 'Blogpost' }
    & Pick<Blogpost, 'id' | 'postDate' | 'content' | 'title' | 'featured' | 'slug'>
    & { headerPhoto?: Maybe<(
      { __typename?: 'UploadFile' }
